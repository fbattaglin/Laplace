...
export default function Diagnostics() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-32 animate-in fade-in">
        ...
        <h3 className="font-medium">Decomposing Signal...</h3>
        <p className="text-sm text-base-secondary">Computing STL, ACF and Forecastability Score</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
      <div>
        <h1 className="text-3xl font-bold tracking-tight mb-2">Diagnostics</h1>
        <p className="text-base-secondary">
          Analyze the structural components of <span className="font-medium text-base-primary">{config.dataset_name}</span>.
        </p>
      </div>

      {/* Forecastability Score Card */}
      <div className="p-8 bg-base-surface rounded-2xl border border-base-secondary/20 flex flex-col md:flex-row gap-8 items-center">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-base-secondary mb-4 leading-relaxed max-w-2xl">
            ...
            A high score means models will likely capture strong trends and seasonal patterns, leading to reliable forecasts.
          </p>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h2 className="text-lg font-semibold">STL Decomposition</h2>
          </div>
          <p className="text-sm text-base-secondary mb-4">Breaks down the series into Trend, Seasonal, and Residual (noise) components.</p>
          
          <div className="p-6 bg-white border border-base-secondary/20 rounded-2xl space-y-6">
            {[
              { key: 'observed', label: 'Observed (Original)', color: '#111111' },
